...
jQuery.fn.wowSlider = function (aj) {
    ...
    function af(aT, aX, a0, k, a2, a1) {
        ...
        aF(document).on((aX ? "mousemove " : "") + "touchmove", aT,
        function (a4) {
            if (!aZ) {
                return
            }
        ...
        aF(document).on((aX ? "mouseup " : "") + "touchend", aT,
        function (a3) {
            if (aj.gestures == 2) {
    ...
    if (aj.controls) {
        ...
        if (/iPhone/.test(navigator.platform)) {
            ab.get(0).addEventListener("touchend",
            function (c) {
                aN(c, x - 1, 1)
            },
            false);
            ag.get(0).addEventListener("touchend",
            function (c) {
                aN(c, x + 1, 0)
            },
            false)
    ...
    function aQ(f, aU, c) {
        var aT = N(f);
        var aV = N(aU);
        var k = aj.captionEffect; (aa[aF.type(k)] || aa[k] || aa.none)(aF.extend({
            $this: H,
            curIdx: x,
            prevIdx: au,
            noDelay: c
    ...
    if (aj.fullScreen) {
        ...
        if (w) {
            ...
            document.addEventListener(w.fullscreenchange,
            function (c) {
                if (an()) {
                    aS = 1;
                    aO()
